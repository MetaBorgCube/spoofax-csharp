...
public class CSharpParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("CSharp");
  ...
  { 
    CSharpParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = CSharpParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = CSharpParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(CSharpParseControllerGenerated.class);
    }
  ...
  { 
    return CSharpParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
